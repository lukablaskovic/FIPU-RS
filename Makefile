...
help:
	...
	@echo 'make pdf SCRIPT=RS1     Generate this lesson PDF locally'
	@echo 'make upload SCRIPT=RS1  Upload this lesson Markdown and existing PDF to Drive'
	@echo 'make sync SCRIPT=RS1    Generate PDF, then upload both files on success'
	@echo 'Choose SCRIPT=RS1 through RS8. These commands do not commit or push.'

check-script:
	@test -n "$$SCRIPT" || { echo 'Choose a lesson, e.g. make sync SCRIPT=RS1'; exit 1; }
