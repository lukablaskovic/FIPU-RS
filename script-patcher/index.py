...
FOLDER_ID = '1hzmr0AfV9R2azSC76n1Ryai0X4FDaTOc'
SCOPES = ['https://www.googleapis.com/auth/drive']
PREFIX = 'RS'
SCRIPTS = tuple(f"{PREFIX}{n}" for n in range(1, 9))
FOLDER_PATTERN = '{script} - *'
SPECIAL_STEMS = {'RS8': 'Raspodijeljeni sustavi Vježba na satu - 23. 1. 2026'}
...
def main():
    parser = argparse.ArgumentParser(description='Upload only the 16 main RS Markdown/PDF files.')
    parser.add_argument('--folder-id', default=FOLDER_ID, help='Destination Google Drive folder ID (default: Raspodijeljeni sustavi)')
    ...
    parser.add_argument('--script', choices=SCRIPTS, help='Select one lesson (default: all 8)')
